...
<s:form id="nctsElecidentifyForm" action="saveNctsElecidentify" method="post" validate="true">
    ...
    <li>
        <table>
            <s:textfield theme="qxhtml" key="nctsElecidentify.applyId" required="true" maxlength="200"
                         cssClass="text medium" readonly="true"/>
            ...
            <s:textfield theme="qxhtml" key="nctsElecidentify.createDate" required="true" maxlength="10"
                         cssClass="text medium" readonly="true"/>
            <s:textfield theme="qxhtml" key="nctsElecidentify.destroyDate" required="true" maxlength="10"
                         cssClass="text medium" readonly="true"/>
            <s:textfield theme="qxhtml" key="nctsElecidentify.identifyCode" required="true" maxlength="50"
                         cssClass="text medium" readonly="true"/>
            <s:textfield theme="qxhtml" key="nctsElecidentify.version" required="true" maxlength="1"
                         cssClass="text medium" readonly="true"/>
    ...
    <!--li class="buttonBar bottom">
        ...
        <c if test="USD{not empty nctsElecidentify.identifyId}">
